...
namespace rock.Migrations
{
    ...
    [Migration("20210428105945_rename roles in user")]
    partial class renamerolesinuser
    {
            ...
            modelBuilder.Entity("rock.Core.Domains.Orders.Order", b =>
                {
                    ...
                    b.HasOne("rock.Core.Domains.Financial.FinancialDocument", "FinancialDocument")
                        .WithMany("Orders")
                        .HasForeignKey("FinancialDocumentId");
            ...
            modelBuilder.Entity("rock.Core.Domains.Payment.OrderPayment", b =>
                {
                    b.HasOne("rock.Core.Domains.Orders.Order", "Order")
                        ...
                        .HasForeignKey("rock.Core.Domains.Payment.OrderPayment", "OrderId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
