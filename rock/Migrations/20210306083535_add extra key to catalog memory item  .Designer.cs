...
namespace rock.Migrations
{
    ...
    [Migration("20210306083535_add extra key to catalog memory item  ")]
    partial class addextrakeytocatalogmemoryitem
    {
            ...
            modelBuilder.Entity("rock.Core.Domains.Shops.ShopStuff", b =>
                {
                    ...
                    b.HasOne("rock.Core.Domains.Products.ProductColor", "ProductColor")
                        .WithOne()
                        .HasForeignKey("rock.Core.Domains.Shops.ShopStuff", "ProductId", "ColorId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
