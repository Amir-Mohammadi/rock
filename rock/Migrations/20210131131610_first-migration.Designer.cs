...
namespace rock.Migrations
{
    ...
    [Migration("20210131131610_first-migration")]
            ...
            modelBuilder.Entity("rock.Core.Domains.Products.ProductBrochureAttachment", b =>
                {
                    ...
                    b.Property<int>("ProductBrochurId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("rock.Core.Domains.Profiles.Profile", b =>
                {
                    ...
                    b.HasIndex("PersonProfileId")
                        .IsUnique()
                        .HasFilter("[PersonProfileId] IS NOT NULL");
            ...
            modelBuilder.Entity("rock.Core.Domains.Products.ProductBrochureAttachment", b =>
                {
                    ...
                    b.HasOne("rock.Core.Domains.Products.ProductBrochure", "Brochure")
                        ...
                        .HasForeignKey("ProductBrochurId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("rock.Core.Domains.Profiles.Profile", b =>
                {
                    ...
                    b.HasOne("rock.Core.Domains.Profiles.CompanyProfile", "Company")
                        .WithOne("Profile")
                        .HasForeignKey("rock.Core.Domains.Profiles.Profile", "CompanyProfileId");

                    b.HasOne("rock.Core.Domains.Profiles.PersonProfile", "Person")
                        .WithOne("Profile")
                        .HasForeignKey("rock.Core.Domains.Profiles.Profile", "PersonProfileId");
